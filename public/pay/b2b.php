<?php
  ...
  $Amount = '10';
  $PartyA = '';                       # Shortcode 1
  $PartyB = '3012059';                       # Shortcode 2
  $AccountReference = 'BusinessPaybill';             # Account Reference mandatory for “BusinessPaybill” CommandID.
  $Remarks = 'floatmngt';                      # Anything Goes here/string/int/varchar
  $QueueTimeOutURL = 'https://ygmlimited.com/admin/payments/B2BResultURL.php';              # QueueTimeOutURL
  $ResultURL = 'https://ygmlimited.com/admin/payments/B2BResultURL.php';                    # ResultURL

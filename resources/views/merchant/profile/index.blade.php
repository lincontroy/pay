...
@section('head')
    @include('layouts.backend.partials.headersection',['title'=>'Merchant Profile'])
@endsection
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table text-center" id="table-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ __('Public Key') }}</td>
                                    <td>{{ Auth()->user()->public_key ?? 'null' }}</td>
                                </tr>
                                <tr>
                                    <td>{{ __('Private Key') }}</td>
                                    <td>{{ Auth()->user()->private_key ?? 'null' }}</td>
                                </tr>
                                <tr>
                                    <td>{{ __('Currency') }}</td>
                                    <td>{{ Auth()->user()->currency ?? 'null' }}</td>
                                </tr>
                                <tr>
                                    <td>{{ __('status') }}</td>
                                    <td>
                        ...
                        <div class="col-sm-12">
                            <a type="submit" href="{{ route('merchant.profile.create') }}"

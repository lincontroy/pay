...
@section('head')
    @include('layouts.backend.partials.headersection',['title'=>'Plan Edit','button_name'=> 'All Plan','button_link'=>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form method="PUT" action="{{ route('admin.plan.update') }}" class="basicform">
                    @csrf
                    <div class="card-body">
                        <div class="form-row">

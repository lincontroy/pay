...
<div class="invoice-box">
    <table cellpadding="0" cellspacing="0">
        ...
        <tr class="item">
            ...
            <td>{{$data->monthly_req ?? 'null'}}</td>
        </tr>
        <tr class="item">
            <td>{{__('Daily Request')}}</td>
            <td>{{$data->daily_req}}</td>
        </tr>

        <tr class="item">
            <td>{{__('Storage Limit')}}</td>
            <td>{{$data->storage_limit}}</td>
        </tr>
        <tr class="item">
            <td>{{__('Payment Id')}}</td>

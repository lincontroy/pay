...
@section('title','User Plan Report')

@section('head')
    @include('layouts.backend.partials.headersection', ['title'=>'User Plan Report'])
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-5">
                        <form action="{{ url('/admin/user-plan-report') }}" type="get">
                            <div class="form-row">
                                <div class="col-lg-5">
                    ...
                    <div class="col-4 mt-2">
                        <form action="/admin/user-plan-report" type="get">
                            <div class="input-group form-row mt-3">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="buttons">
                            <a href="{{ route('admin.user-plan-report.pdf')}}" class="btn btn-icon btn-dark">{{ __('pdf') }}</a>
                            <a href="{{ route('admin.user-plan-report.csv')}}" class="btn btn-icon btn-dark">{{ __('csv') }}</a>
                            <a href="{{ route('admin.user-plan-report.excel')}}" class="btn btn-icon btn-dark">{{ __('excel') }}</a>
                        </div>
                    </div>
                </div>

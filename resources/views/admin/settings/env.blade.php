                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-4">
                            <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#mailchimp" role="tab" aria-controls="contact" aria-selected="false">{{ __('Mailchimp') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#reCAPTCHA" role="tab" aria-controls="contact" aria-selected="false">{{ __('Google reCAPTCHA') }}</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content no-padding" id="myTab2Content">
                                    ...
                                    <div class="custom-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" id="CONTENT_EDITOR" name="content_editor">
                                                <option value="true" @if(env('CONTENT_EDITOR') === true) selected="" @endif>{{ __('True') }}</option>
                                                <option value="false" @if(env('CONTENT_EDITOR') === false) selected="" @endif>{{ __('False') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="mail_area" role="tabpanel" aria-labelledby="profile-tab4">
                                    <div class="custom-form">
                                        ...
                                        <div class="form-group">
                                            <label for="QUEUE_MAIL">{{ __('QUEUE_MAIL') }}</label>
                                            <select class="form-control" name="QUEUE_MAIL" id="QUEUE_MAIL">
                                ...
                                <div class="tab-pane fade" id="reCAPTCHA" role="tabpanel" aria-labelledby="profile-tab4">
                                    <div class="custom-form">
                                        <div class="form-group">
                                            <label for="NOCAPTCHA_SITEKEY">{{ __('NOCAPTCHA_SITEKEY') }}</label>
                                            <input type="text" name="NOCAPTCHA_SITEKEY" class="form-control" value="{{ env('NOCAPTCHA_SITEKEY') }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="NOCAPTCHA_SECRET">{{ __('NOCAPTCHA_SECRET') }}</label>
